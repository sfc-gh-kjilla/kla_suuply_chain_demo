...
export const ShippingComparison: React.FC<ShippingComparisonProps> = ({ 
  ...
  const sortedOptions = [...availableOptions].sort((a, b) => a.TOTAL_COST - b.TOTAL_COST);
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ 
        ...
        {topOptions.map((option, idx) => {
          ...
          const importDuty = option.TAX_AMOUNT * 0.3;
          const vatAmount = option.TAX_AMOUNT * 0.7;
              ...
              <div style={{ padding: '12px', flex: 1 }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: '10px', color: colors.textMuted }}>Total Cost</div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '11px' }}>
                    ...
                    <div style={{ 
                      ...
                      <span style={{ color: colors.success }}>${option.TOTAL_COST.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
