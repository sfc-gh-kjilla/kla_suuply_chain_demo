...
function daysAgo(days: number, time = '08:00:00'): string {
  const d = new Date();
...
export const mockEscalationCases: EscalationCase[] = [
  {
    ...
    CREATED_DATE: daysAgo(4, '08:00:00'),
    LAST_UPDATED: daysAgo(0, '06:15:00'),
    AGE_DAYS: 4,
    SLA_TARGET_HOURS: 24,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(4, '08:00:00'), AUTHOR: 'Park Jin-soo', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Initial case opened. Power readings dropping consistently over past 48 hours. Now at 82.3mW.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(4, '14:00:00'), AUTHOR: 'Park Jin-soo', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Confirmed CLBO crystal from batch B-2024-X. Matches Service Bulletin SB-2024-0892.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(3, '09:00:00'), AUTHOR: 'Samsung Fab Ops', AUTHOR_ROLE: 'Customer', MESSAGE: 'Two production lines impacted. Need resolution ETA within 24 hours or escalation to VP level.', TYPE: 'EMAIL' },
      { TIMESTAMP: daysAgo(3, '10:00:00'), AUTHOR: 'Park Jin-soo', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Escalating to SEV1. Requesting emergency crystal shipment from Singapore Hub.', TYPE: 'ESCALATION' },
      { TIMESTAMP: daysAgo(2, '08:00:00'), AUTHOR: 'Kim Soo-yeon', AUTHOR_ROLE: 'Regional Manager', MESSAGE: 'Crystal shipment approved from Singapore. Parts request submitted.', TYPE: 'PARTS_REQUEST' },
      { TIMESTAMP: daysAgo(0, '06:15:00'), AUTHOR: 'Park Jin-soo', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Part in transit. Expected delivery by end of day. Customer updated on ETA.', TYPE: 'STATUS_UPDATE' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(2, '02:00:00'),
    LAST_UPDATED: daysAgo(1, '22:00:00'),
    AGE_DAYS: 2,
    SLA_TARGET_HOURS: 24,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(2, '02:00:00'), AUTHOR: 'Tanaka Hiroshi', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Urgent: power dropped to 78.9mW during active production run. 12 wafers lost. Tool taken offline.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(2, '06:00:00'), AUTHOR: 'Renesas Fab Manager', AUTHOR_ROLE: 'Customer', MESSAGE: 'Requesting root cause analysis and timeline for repair. Yield impact assessment needed.', TYPE: 'EMAIL' },
      { TIMESTAMP: daysAgo(2, '10:00:00'), AUTHOR: 'Tanaka Hiroshi', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Crystal inspection confirms thermal damage. Batch B-2024-X. Also recommending mirror assembly inspection.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(1, '22:00:00'), AUTHOR: 'Tanaka Hiroshi', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Parts ordered. Singapore and Dresden both have stock. Awaiting shipment confirmation.', TYPE: 'PARTS_REQUEST' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(8, '04:00:00'),
    LAST_UPDATED: daysAgo(1, '08:00:00'),
    AGE_DAYS: 8,
    SLA_TARGET_HOURS: 72,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(8, '04:00:00'), AUTHOR: 'Lin Mei-hua', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Power readings unstable: 89-93mW range. Crystal batch B-2024-X. Opened as SEV2 per trending analysis.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(6, '10:00:00'), AUTHOR: 'TSMC Fab 15 Ops', AUTHOR_ROLE: 'Customer', MESSAGE: 'Maintenance window available in 8-9 days. Can we schedule crystal replacement?', TYPE: 'EMAIL' },
      { TIMESTAMP: daysAgo(4, '09:00:00'), AUTHOR: 'Lin Mei-hua', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Crystal from batch B-2024-A requested. Waiting on inventory availability.', TYPE: 'PARTS_REQUEST' },
      { TIMESTAMP: daysAgo(1, '08:00:00'), AUTHOR: 'Lin Mei-hua', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Part backordered at San Jose. Checking Singapore and Tucson hubs.', TYPE: 'STATUS_UPDATE' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(3, '06:00:00'),
    LAST_UPDATED: daysAgo(1, '14:00:00'),
    AGE_DAYS: 3,
    SLA_TARGET_HOURS: 72,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(3, '06:00:00'), AUTHOR: 'Kim Dong-hyun', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Post-calibration beam current above normal range. Correlates with power degradation trend.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(2, '12:00:00'), AUTHOR: 'Kim Dong-hyun', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Crystal is batch B-2024-X. May need replacement but attempting optics adjustment first.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(1, '14:00:00'), AUTHOR: 'Kim Dong-hyun', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Optics adjustment provided temporary improvement. Monitoring for 48 hours before deciding on crystal swap.', TYPE: 'STATUS_UPDATE' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(6, '16:00:00'),
    LAST_UPDATED: daysAgo(2, '10:00:00'),
    AGE_DAYS: 6,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(6, '16:00:00'), AUTHOR: 'John Martinez', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Opened monitoring case. Power decline rate ~0.4mW/day. Batch B-2024-X confirmed.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(2, '10:00:00'), AUTHOR: 'John Martinez', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Customer informed. They prefer to plan replacement during next scheduled downtime in 8 days.', TYPE: 'EMAIL' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(1, '02:00:00'),
    LAST_UPDATED: daysAgo(1, '18:00:00'),
    AGE_DAYS: 1,
    SLA_TARGET_HOURS: 168,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(1, '02:00:00'), AUTHOR: 'Chen Wei-lin', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Coolant flow sensor flagging intermittent drops below 9 L/min. Scanner still operational at 115.2mW.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(1, '18:00:00'), AUTHOR: 'Chen Wei-lin', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Requested 2-hour inspection window from TSMC ops. Awaiting response.', TYPE: 'STATUS_UPDATE' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(7, '10:00:00'),
    LAST_UPDATED: daysAgo(1, '16:00:00'),
    AGE_DAYS: 7,
    SLA_TARGET_HOURS: 72,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(7, '10:00:00'), AUTHOR: 'Müller Hans', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Optics contamination sensor reading 18ppm. Cleaned but reading returned within 24 hours.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(5, '14:00:00'), AUTHOR: 'Müller Hans', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Root cause may be outgassing from crystal batch B-2024-X accelerating contamination.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(3, '09:00:00'), AUTHOR: 'IMEC Lab Director', AUTHOR_ROLE: 'Customer', MESSAGE: 'Research timeline flexible but need reliable tool within 3 days for next experimental run.', TYPE: 'EMAIL' },
      { TIMESTAMP: daysAgo(1, '16:00:00'), AUTHOR: 'Müller Hans', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Ordering optics cleaning kit and crystal replacement. Planning full service in 2 days.', TYPE: 'PARTS_REQUEST' },
    ],
  },
  {
    ...
    CREATED_DATE: daysAgo(16, '14:00:00'),
    LAST_UPDATED: daysAgo(11, '10:00:00'),
    AGE_DAYS: 16,
    ...
    COMMUNICATION_LOG: [
      { TIMESTAMP: daysAgo(16, '14:00:00'), AUTHOR: 'Maria Garcia', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Vibration readings elevated after site-wide power interruption yesterday.', TYPE: 'NOTE' },
      { TIMESTAMP: daysAgo(14, '10:00:00'), AUTHOR: 'Maria Garcia', AUTHOR_ROLE: 'Field Engineer', MESSAGE: 'Recalibration completed. Vibration back within normal range.', TYPE: 'STATUS_UPDATE' },
      { TIMESTAMP: daysAgo(11, '10:00:00'), AUTHOR: 'Maria Garcia', AUTHOR_ROLE: 'Field Engineer', MESSAGE: '5-day monitoring shows stable readings. Closing case.', TYPE: 'STATUS_UPDATE' },
    ],
  },
];
